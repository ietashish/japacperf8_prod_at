...
TNT.a = (function() {
 ...
 clientCode: "japacperf8",
 serverHost: "japacperf8.tt.omtrdc.net",
 mboxTimeout: 20000,
 ...
 imsOrgId: "C3E23FE452A536D60A490D45@AdobeOrg",
 ...
 return mboxCookiePageDomain(true);
 }
 },
...
(function(X, W, c, b, Tb) {
 ...
 function Bc(ac, Cc) {
 return Cc && W.cb(ac.isOptedOut) &&
 !W.Z(window.Visitor.OptOut);
 }
...
mboxFactory = function(Ab, mb, Se) {
 ...
 this.Ve = b.mboxIsSupportedFunction() &&
 ...
 this.We = this.We &&
 W.ab(this.Kd.getCookie(H.D)) &&
 W.ab(this.Kd.getCookie(H.K));
 ...
 var vd = this;
 this.addOnLoad(function() { vd.kf = new Date().getTime(); });
...
mboxFactory.prototype.create = function(x, nb, xf) {
 var Tc = this.yf(x, nb, xf);

 if (Tc) {
 this.uf(Tc.getUrlBuilder(), x);
 }
...
mboxFactory.prototype.zf = function(x, nb, xf) {
 return this.yf(x, nb, xf);
};

mboxFactory.prototype.yf = function(x, nb, xf) {
 if (!this.isSupported()) {
 return null;
 }

 var Af = new Date();
 var A = Af.getTime() - (Af.getTimezoneOffset() * TNT.a.M.Q);
 ...
 Tc = new mbox(x, y, Mc, fe, this.Bf(x), this);
 ...
 this.disable();
 throw 'Failed creating mbox "' + x + '", the error was: ' + Cf;
 }

 return Tc;
};

mboxFactory.prototype.Df = function(Mc) {
 var m = this.gf.getId();
...
mboxFactory.prototype.Ef = function(Mc, x) {
 var Ff = !TNT.isAutoCreateGlobalMbox() && TNT.getGlobalMboxName() === x;
...
mboxFactory.prototype.uf = function(Mc, x) {
 ...
 if (i) {
 Mc.addParameter(Gf, i);
 }
};

mboxFactory.prototype.wf = function(Mc) {
 var te = TNT.a;
...
mboxFactory.prototype.vf = function(Mc, x) {
 this.Df(Mc);
 this.Ef(Mc, x);
 this.wf(Mc, x);
};
...
mboxFactory.prototype.Bf = function(x) {
...
(function(X, a, W, b, c, M){
 ...
 Mc.addParameter(c.A, Af.getTime() - wg);
 Mc.addParameter(c.d, mboxGenerateId());
...
(function(X){
 ...
 window.mboxDefine = function(xf, x ) {
 var c = [].slice.call(arguments, 2);

 return X.cg(Uc, xf, x, c);
 };
